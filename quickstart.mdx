...
<Card title="Embedded Flow (with Stripe)" icon="credit-card" href="/guides/embedded-flow/overview">
  Add Quidkey bank payments alongside your existing Stripe Payment Element. Customers choose between card or bank transfer at checkout.

  **Best for:** Merchants with an existing Stripe checkout

  **You'll need:** Backend + frontend code (Stripe already integrated)
</Card>
