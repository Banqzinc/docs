...
<Card title="Try Authentication" icon="key" href="/api-reference/auth/issue-a-new-access-token">
...
<CardGroup cols={2}>
<Card title="Authentication" icon="key" href="/api-reference/auth/issue-a-new-access-token">
  Obtain and refresh access tokens
</Card>

<Card title="Embedded Payment Flow" icon="credit-card" href="/api-reference/embedded/create-payment-request">
  Create, update, and initiate payments
</Card>

<Card title="Webhooks" icon="webhook" href="/api-reference/webhooks/register-webhook">
