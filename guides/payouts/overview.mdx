...
<CardGroup cols={2}>
<Card title="Export Transactions" icon="file-csv" href="/guides/payouts/export">
  Download a CSV of all transactions in a payout batch
</Card>
...
From the detail page you can export all transactions as a CSV for reconciliation with your accounting system.
...
<Step title="Export the transaction CSV">
  Download the CSV to get a line-by-line breakdown of every transaction, including fees, exchange rates, and customer details. See [Export transactions](/guides/payouts/export) for the full field reference.
</Step>

<Step title="Import into your accounting system">
  Use the CSV to match individual transactions against your invoices or orders using the **Order ID** and **Transaction Number** fields.
</Step>
</Steps>

<Tip>
The **Order ID** field in the CSV corresponds to the `order_id` you provided when creating the payment. Use this to link payout transactions back to your internal records.
</Tip>
...
<CardGroup cols={2}>
<Card title="Export transactions" icon="file-csv" href="/guides/payouts/export">
  Download and understand the transaction CSV
</Card>
