...
Navigate to **Payouts** in the Console to see all your payout batches. You can filter by status:
...
<Step title="Match the payout to your bank statement">
  Find the payout in your bank statement using the **payment reference**. This reference appears both in the Console and on your bank transaction.
</Step>

<Step title="Open the payout detail">
  Click the matching batch in the Console to see the amount breakdown and verify the payout amount matches your bank statement.
</Step>
