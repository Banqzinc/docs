...
<Tip>
**Need both?** You can use the Embedded Flow for your checkout page and Hosted Checkout for invoice emails — they share the same backend API and webhook infrastructure.
</Tip>
