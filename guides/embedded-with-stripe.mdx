...
- [ ] Quidkey `client_id` and `client_secret` ([contact us](mailto:rabea@quidkey.com) to get yours)
...
<Card title="Interactive API Playground" icon="flask" href="/api-reference/embedded/create-payment-request">
