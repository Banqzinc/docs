...
<Note>
This page is a quick orientation. If you're not already on Stripe, the [Redirect flow](/guides/payment-api/accept-a-payment/redirect) is the flagship integration and the best place to start. The full Embedded walkthrough lives in the dedicated [Embedded Flow guide](/guides/embedded-flow/overview).
</Note>
