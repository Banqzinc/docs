...
```bash cURL
curl 'https://core-dev.quidkey.com/api/v1/payment-links/LINK_ID' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```

```javascript Node.js
const response = await fetch(
  `https://core-dev.quidkey.com/api/v1/payment-links/${linkId}`,
  {
...
response = requests.get(
    f'https://core-dev.quidkey.com/api/v1/payment-links/{link_id}',
...
curl 'https://core-dev.quidkey.com/api/v1/payment-links?status=active&limit=20' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'

# Search by payment reference
curl 'https://core-dev.quidkey.com/api/v1/payment-links?search=INV-2024' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
...
// List all active links
const response = await fetch(
  'https://core-dev.quidkey.com/api/v1/payment-links?status=active&limit=20',
  {
    headers: { 'Authorization': `Bearer ${accessToken}` }
  }
);
...
# List all active links
response = requests.get(
    'https://core-dev.quidkey.com/api/v1/payment-links',
    headers={'Authorization': f'Bearer {access_token}'},
